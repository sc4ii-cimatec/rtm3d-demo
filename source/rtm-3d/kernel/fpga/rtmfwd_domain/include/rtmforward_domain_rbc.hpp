...
#include "xf_blas.hpp"
#include "rtm_domain.hpp"
#include "domain.hpp"
#include "interface.hpp"

using namespace xf::rtm;
typedef Domain<RTM_maxZ, RTM_maxY, RTM_order / 2, RTM_nPEZ, RTM_nPEX, RTM_numFSMs> DOMAIN_TYPE;
typedef RTMDomain<DOMAIN_TYPE, RTM_dataType, RTM_order, RTM_maxZ, RTM_maxY, RTM_MaxB, RTM_nPEZ, RTM_nPEX> RTM_TYPE;
